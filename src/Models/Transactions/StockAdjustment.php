...
namespace Azaharizaman\LaravelInventoryManagement\Models\Transactions;

use Azaharizaman\LaravelInventoryManagement\Database\Factories\Transactions\StockAdjustmentFactory;
